...
public class Week05OOPLab {
	...
	public static void main(String[] args) {
		...
		Card testCard = new Card("Ten", "Clubs", 10);
		...
		int numPlayers = 5;
		Map<String, List<Card>> gameBoard = createGameBoard(numPlayers);
	...
	public static Map<String, List<Card>> createGameBoard(int numPlayers){
		...
		int currentPlayer = 0;
		while( gameDeck.isDeckNotEmpty()) {
			gameBoard.get("Player "+ (currentPlayer+1)).add(gameDeck.draw());
			currentPlayer++;
